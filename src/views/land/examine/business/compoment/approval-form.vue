    ...
    <el-form :disabled="currentDisabled" :model="formLabel" :rules="rules" ref="form">
      <table border="0" cellspacing="0" cellpadding="0"
        ...
        <tr style="height:38px;" class="has_filled">
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.hzxx.xm"></el-input>
            </div>
          </td>
          ...
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.hzxx.sfzh"></el-input>
            </div>
          </td>
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.hzxx.jtzz"></el-input>
            </div>
          </td>
          <td colspan="4" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.hzxx.sqly"></el-input>
            </div>
          </td>
        </tr>
        ...
        <tr style="height:38px;">
          ...
          <td colspan="2" class="s17">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.zjdmj"></el-input>
              ㎡
            </div>
          </td>
          ...
          <td class="s17">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.fjzdmj"></el-input>
              ㎡
            </div>
          </td>
          ...
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.dz"></el-input>
            </div>
          </td>
        </tr>
        <tr style="height:38px;">
          ...
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.szdz"></el-input>
            </div>
          </td>
          <td class="s15">南至：</td>
          <td colspan="2" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.sznz"></el-input>
            </div>
          </td>
        ...
        <tr style="height:38px;">
          ...
          <td colspan="3" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.szxz"></el-input>
            </div>
          </td>
          <td class="s15">北至：</td>
          <td colspan="2" class="s15">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.szbz"></el-input>
            </div>
          </td>
        </tr>
        <tr style="height:38px;">
        ...
        <tr style="height:38px;">
          ...
          <td colspan="2" class="s17">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.zfjzmj"></el-input>
              ㎡
            </div>
          </td>
          ...
          <td class="s17">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.jzcs"></el-input>
              层
            </div>
          </td>
          ...
          <td colspan="3" class="s17">
            <div class="flex_v_center">
              <el-input v-model="formLabel.nzjdqk.jzgd"></el-input>
              ㎡
            </div>
          </td>
        </tr>
