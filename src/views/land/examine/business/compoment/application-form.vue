...
<!--            </el-row>-->
            ...
            <h2>家庭成员</h2>
            <el-button type="success" @click="addJTCYDomain" size="mini" style="display: inline;">新增成员</el-button>
...
<!--                <el-col :span="2">-->
                    <el-form-item :label="`序号${(index + 1)}`">
                        <el-button type="danger" size="mini" @click.prevent="removeJTCYDomain(domain)">删除</el-button>
                    </el-form-item>
<!--                </el-col>-->
            </el-row>
