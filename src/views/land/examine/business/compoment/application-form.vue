    ...
    <el-form :disabled="disabled" :model="form" :rules="rules" ref="form" :class="{validForm: !showValidMsg}">
      <table border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;margin:0px auto;max-width:1000px">
        ...
        <tr style="height:38px;">
          ...
          <td class="s8" style="font-size:1px;">
            <el-form-item prop="jcxx.lxdh">
        ...
        <tr style="height:38px;">
          ...
          <td colspan="8" class="s18" style="font-size:1px;">
            <el-form-item prop="jcxx.sfzh">
              <el-input v-model="form.jcxx['sfzh']" placeholder="身份证号"></el-input>
            </el-form-item>
          </td>
          <td colspan="5" class="s18">户口所在地</td>
          <td colspan="6" class="s18" style="font-size:1px;">
            <el-form-item prop="jcxx.hksz">
              <el-input v-model="form.jcxx['hksz']" placeholder="户口所在地"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr style="height:38px;">
        ...
        <tr v-for="(cyItem,index) in form.jtcy" style="height:38px;">
          <td colspan="3" class="s18" style="font-size:1px;">
          ...
          <td colspan="6" class="s18" style="font-size:1px;">
            <el-input v-model="cyItem['yhzgx']"></el-input>
          </td>
          <td colspan="5" class="s18" style="font-size:1px;">
            <el-input v-model="cyItem['sfzh']"></el-input>
          </td>
          <td colspan="7" class="s18" style="font-size:1px;">
            <el-input v-model="cyItem['hkszd']"></el-input>
          </td>
        </tr>
        <!-- <tr style="height:38px;">
        ...
        <tr style="height:38px;">
          ...
          <td colspan="5" class="s18" style="font-size:1px;">
            <el-form-item prop="xzjxqk.qszsh">
        ...
        <tr style="height:38px;">
          ...
          <td colspan="20" class="s18" style="font-size:1px;">
            <el-form-item prop="nzjdqk.dz">
        ...
        <tr style="height:38px;">
          ...
          <td colspan="25" class="s22" style="font-size:1px;">
            <el-form-item prop="qt.cmxzyj">
              <el-input type="textarea" v-model="form.qt['cmxzyj']" placeholder="村民小组意见"></el-input>
            </el-form-item>
          </td>
        </tr>
        <tr style="height:38px;">
