<template>
    <d2-container>
        <el-collapse v-model="activeNames">
            ...
            <el-collapse-item title="信息列表" name="2">
                <template slot="title">
        ...
        <el-dialog title="查看详情" :visible.sync="dialogDetailVisible" top="5vh">
            <el-tabs type="border-card">
                ...
                <el-tab-pane label="影像信息">
                    <fileTreeView :xmbh="dialogDetailItem.xmbh" :stage="''" readonly></fileTreeView>
                </el-tab-pane>
            </el-tabs>
        </el-dialog>
...
<script>
  ...
  export default {
    ...
    created() {
      this.currentStage = this.getOptionByContent('项目阶段', '退办件')
      this.getTableData()
    },
    methods: {
      getTableData() {
