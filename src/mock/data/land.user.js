...
export const userDB = [
  ...
  {
    username: 'xzzf_spry', password: '111111', uuid: 'xzzf_spry-uuid', name: '乡镇政府-审批人员', role: ['sp-check-2']
  },
  {
    username: 'xzzf_ysfqry', password: '111111', uuid: 'xzzf_ysfqry-uuid', name: '乡镇政府-验收发起人员', role: ['ys-start']
  },
  {
    username: 'xzzf_ysry', password: '111111', uuid: 'xzzf_ysry-uuid', name: '乡镇政府-验收人员', role: ['ys-check-2']
  },
  {
  ...
  {
    username: 'zrzy_shry', password: '111111', uuid: 'zrzy_shry-uuid', name: '自然资源部门-审核人员', role: ['sp-check-1']
  },
  {
    username: 'zrzy_ysry', password: '111111', uuid: 'zrzy_ysry-uuid', name: '自然资源部门-验收人员', role: ['ys-check-1']
  }
]
